...
import India from "../public/images/Flag_of_India.svg.webp";
      ...
      <div className="max-w-7xl mx-auto py-4 px-4 sm:px-6 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3 sm:space-x-6">
          <Image
            ...
            height={18}
            alt="country flag"
            className="shadow-md cursor-pointer object-cover"
          />

          <div className="relative">
            <Bell className="w-5 sm:w-6 text-gray-300 cursor-pointer hover:text-white" />
          </div>
